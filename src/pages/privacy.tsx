    ...
    >
      ...
      <div>
        ...
        <p>
          ...
          Пользователем на его усмотрение. Сбор персональных данных производится
          через формы заполнения на Сайте.
        </p>
        <p>
        ...
        <p>
          1.1.3.&nbsp;Данные, которые автоматически передаются сервисам Сайта в
          ...
          различных средств связи, а именно посредством: интернет; сообщений на
          адрес электронной почты; коротких текстовых сообщений (SMS) и
          мультимедийных сообщений (MMS) на номер телефона; а также посредством
          использования информационно-коммуникационных сервисов, таких как
        ...
        <p>
          ...
          необходима для предоставления сервисов или оказания услуг и исполнения
        ...
        <p>
          2.2.6. Создания учетной записи для доступа в личный кабинет на Сайте,
