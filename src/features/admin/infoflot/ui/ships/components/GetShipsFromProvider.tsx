...
const InfoflotShipsId = [
  ...
  250, 970, 430, 975, 365, 982, 362, 988, 83,969
];

const ShipNameFromExel = {
  Президент: false,
  ['Илья Муромец']: false,
  ['Михаил Танич']: false,
  Бородино: false,
  ['К.А. Тимирязев']: false,
  ['Григорий Пирогов']: false,
  Россия: false,
  ['Огни большого города']: false,
  ['Маленький принц']: false,
  ['Лунная соната']: false,
  ['Лебединое озеро']: false,
  ['Симфония севера']: false,
  ['Н.А. Некрасов']: false,
  ['Александр Бенуа']: false,
  ['Северная сказка']: false,
  ['Антон Чехов']: false,
  ['Александра (Т.Г. Шевченко)']: false,
  ['Сергей Дягилев']: false,
  ['Максим Литвинов']: false,
  ['Волга Стар']: false,
  ['Генерал Лавриненков']: false,
  ...
  ['Две столицы']: false,
  ['Капитан Пушкарев']: false,
  ['Космонавт Гагарин']: false,
  ['А.И. Герцен']: false,
  ['Александр Великий']: false,
  ...
  ['Н.В. Гоголь']: false,
  ['Павел Бажов']: false,
  ['Профессор Хромов']: false,
  ['Гранд Адмирал']: false,
  ['Астория Гранде']: false,
};
